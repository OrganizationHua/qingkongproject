...
public class BaseAdapter<T extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<T> {
    ...
    public List<String> listDatas;//数据源
    ...
    public BaseAdapter(Context context, List<String> listDatas) {
     ...
     */
    public BaseAdapter(Context context, List<String> listDatas, OnViewClickListener onViewClickListener) {
        init(context,listDatas);
     ...
     * @param listDatas
     */
    void init(Context context, List<String> listDatas){
