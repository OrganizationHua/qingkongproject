...
public class ImageAdapter extends BaseAdapter<ImageAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        RelativeLayout.LayoutParams lp = new RelativeLayout.LayoutParams((dm.widthPixels - dip2px(32)) / 3, (dm.widthPixels - dip2px(32)) / 3);
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.iv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, PicActivity.class).putExtra("imgurl",url);
