...
public class RecycleViewItemTouchCallback extends ItemTouchHelper.Callback {
    ...
    public RecycleViewItemTouchCallback(ItemTouchAdapter itemTouchAdapter) {
    ...
    public void onChildDraw(Canvas c, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder,
        ...
        if (viewHolder.getAdapterPosition() != pos) {
            viewHolder.itemView.setBackgroundResource(R.drawable.normal_bg);
        }
    ...
    public RecycleViewItemTouchCallback setOnDragListener(OnDragListener onDragListener) {
