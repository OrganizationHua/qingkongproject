package com.iwangcn.qingkong.ui.view.freshwidget.header;
...
import com.iwangcn.qingkong.ui.view.freshwidget.IHeaderView;
import com.iwangcn.qingkong.ui.view.freshwidget.OnAnimEndListener;
...
public class SinaRefreshView extends FrameLayout implements IHeaderView {
    ...
    private void init(Context context) {
        ...
        refreshingStr = getContext().getResources().getString(R.string.cube_ptr_refreshing);
    }
